...
/**
 * Controller class for the keyboard note identification tab.
 * Associated FXML file: keyboard_pane.fxml
 */
public class KeyboardController {
	...
	public void initialize() {
		m_currentNote = ImagePath.setRandomPianoNoteImage(notesImg);
		
		// If the pressed button is the correct answer, show a new 
		// image. If it isn't, show a dialog. 
